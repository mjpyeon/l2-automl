...
parser.add_argument('--preproc', action='store_true', default=False, help='used log&sign proprecessing for nn opt')
parser.add_argument('--opt_hidden', type=int, default=20, help='number of hidden lstm size for nn opt')
